...
export default function HorizontalScroll() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div
        ref={containerRef}
        className="horizontal-container flex flex-nowrap h-screen overflow-x-hidden overflow-y-hidden"
        style={{ width: `${8 * 100}%` }}
      >
        {/* Speech Panel */}
        <section className="horizontal-panel bg-black min-w-screen h-full flex flex-col justify-center items-center px-12 relative">
          <div className="text-center">
            <h1 className="text-8xl font-extrabold mb-12">Speech Division</h1>
            <img
              src="/images/speech1.webp"
              alt="speech division"
              className="rounded-lg shadow-lg mx-auto mb-10 max-w-lg h-auto object-contain"
            />
            <div className="flex justify-center gap-20">
              <div>
                <h3 className="text-5xl font-bold">50+</h3>
                <p className="text-gray-400 text-base mt-2">Active members</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">20+</h3>
                <p className="text-gray-400 text-base mt-2">Workshops organized</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">80%</h3>
                <p className="text-gray-400 text-base mt-2">Competition success rate</p>
              </div>
            </div>
          </div>
          <div className="absolute right-20 bottom-24 text-right">
            <p className="text-gray-400 uppercase text-sm mb-2">Focus</p>
            <p className="font-semibold text-xl mb-6">Public speaking and confident expression</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Activities</p>
            <p className="font-semibold text-xl mb-6">Workshops, competitions, peer coaching</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Skills Developed</p>
        ...
        <section className="horizontal-panel bg-black min-w-screen h-full flex flex-col pt-24 px-24">
          <h1 className="text-7xl font-extrabold mb-12 text-left w-3/4">
            UESC Speech nurtures confident speakers who can inspire, persuade, and express themselves effectively
          </h1>
          {/* MODIFICATION HERE: h-full removed */}
          <div className="flex items-end gap-20 w-full">
            <div className="w-1/2 flex justify-start">
              <img
                src="/images/speech2.webp"
                alt="A person giving a passionate speech"
                className="rounded-lg shadow-2xl max-w-2xl h-auto object-cover"
              />
            </div>
        ...
        <section className="horizontal-panel bg-black min-w-screen h-full flex flex-col justify-center items-center px-12 relative">
          <div className="text-center">
            <h1 className="text-8xl font-extrabold mb-12">Debate Division</h1>
            <img
            ...
            <div className="flex justify-center gap-20">
              <div>
                ...
                <p className="text-gray-400 text-base mt-2">Active debaters</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">15</h3>
                <p className="text-gray-400 text-base mt-2">Tournaments participated</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">70%</h3>
                <p className="text-gray-400 text-base mt-2">Average success rate</p>
              </div>
            </div>
          </div>
          <div className="absolute right-20 bottom-24 text-right">
            <p className="text-gray-400 uppercase text-sm mb-2">Focus</p>
            <p className="font-semibold text-xl mb-6">Logical thinking and persuasive skills</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Activities</p>
            <p className="font-semibold text-xl mb-6">Debates, strategy sessions, team training</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Skills Developed</p>
            <p className="font-semibold text-xl leading-tight">
        ...
        <section className="horizontal-panel bg-black min-w-screen h-full flex flex-col justify-center items-center px-12 relative">
          <div className="text-center">
            <h1 className="text-8xl font-extrabold mb-12">Scrabble Division</h1>
            <img
            ...
            <div className="flex justify-center gap-20">
              <div>
                ...
                <p className="text-gray-400 text-base mt-2">Active players</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">50+</h3>
                <p className="text-gray-400 text-base mt-2">Tournaments organized</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">90%</h3>
                <p className="text-gray-400 text-base mt-2">Member retention rate</p>
              </div>
            </div>
          </div>
          <div className="absolute right-20 bottom-24 text-right">
            <p className="text-gray-400 uppercase text-sm mb-2">Focus</p>
            <p className="font-semibold text-xl mb-6">Vocabulary and strategy development</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Activities</p>
            <p className="font-semibold text-xl mb-6">Scrabble games, tournaments, training</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Skills Developed</p>
            <p className="font-semibold text-xl leading-tight">
        ...
        <section className="horizontal-panel bg-black min-w-screen h-full flex flex-col justify-center items-center px-12 relative">
          <div className="text-center">
            <h1 className="text-8xl font-extrabold mb-12">MUN Division</h1>
            <img
            ...
            <div className="flex justify-center gap-20">
              <div>
                ...
                <p className="text-gray-400 text-base mt-2">Active delegates</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">10+</h3>
                <p className="text-gray-400 text-base mt-2">Conferences attended</p>
              </div>
              <div>
                <h3 className="text-5xl font-bold">85%</h3>
                <p className="text-gray-400 text-base mt-2">Resolution success rate</p>
              </div>
            </div>
          </div>
          <div className="absolute right-20 bottom-24 text-right">
            <p className="text-gray-400 uppercase text-sm mb-2">Focus</p>
            <p className="font-semibold text-xl mb-6">Diplomacy and international understanding</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Activities</p>
            <p className="font-semibold text-xl mb-6">Simulations, trainings, conferences</p>
            <p className="text-gray-400 uppercase text-sm mb-2">Skills Developed</p>
            <p className="font-semibold text-xl leading-tight">
